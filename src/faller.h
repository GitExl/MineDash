...
#define FALLER_TYPE_GOLD    0b00001000
#define FALLER_TYPE_DIAMOND 0b00010000
...
#define FALLER_DATA_DELAY 0b00000111
#define FALLER_DATA_TYPE  0b00011000
#define FALLER_DATA_STATE 0b11100000

#define FALLER_DATA_DELAY_SHIFT 0
#define FALLER_DATA_TYPE_SHIFT  3
#define FALLER_DATA_STATE_SHIFT 5
